!(function (t, e) {
    ...
    var s,
        ...
        V = function (t) {
            ...
            (this.target = t),
                ...
                (this.devicePixelContentBoxSize = r([
                ...
                (t.prototype.observe = function () {
                    var t = this,
                        e = function () {
                            return (
                                t.observer &&
                                t.observer.observe(document.body, E)
                            );
                        };
                    document.body
                        ? e()
        ...
        constructor(t = {}) {
            (this._lastRunUnix = Date.now()),
                ...
                (this._updateDom = () => {
                    ...
                    (c.className = o),
                        (c.href = "https://github.com/dsrkafuu/sakana-widget"),
                        (c.target = "_blank"),
                        (c.innerHTML =
                ...
                (this._draw = () => {
                    ...
                    if (
                        ...
                        const s = i - o / 2,
                            { nx: r, ny: n } = this._calcCenterPoint(
                                t,
                                s,
                                h,
                                e
                ...
                (this._magicForce = () => {
                    if (Math.random() < 0.1) {
                        ...
                        (this._state.t =
                            this._state.t + 150 * (Math.random() - 0.5)),
                            (this._state.w =
                                this._state.w + 200 * (Math.random() - 0.5));
                    this._running ||
                        ((this._running = !0),
                        requestAnimationFrame(this._run)),
                ...
                (this.mount = (t) => {
                    ...
                    this._options.draggable &&
                        (this._domImage.addEventListener(
                            "mousedown",
                            this._onMouseDown
                        ),
                        this._domImage.addEventListener(
                        ...
                        this._domCtrlPerson.addEventListener(
                            "click",
                            this.nextCharacter
                        ),
                        ...
                        this._domCtrlClose.addEventListener(
                            "click",
                            this.unmount
                        ),
                        this._options.autoFit &&
                            (this._onResize(
                                this._domWrapper.getBoundingClientRect()
                            ),
                            (this._resizeObserver = new O(
                                G((t) => {
                                    t &&
                                        t[0] &&
                                        this._onResize(t[0].contentRect);
                                })
                            )),
                ...
                (this.unmount = () => {
                    this._domImage.removeEventListener(
                        ...
                        this._domCtrlClose.removeEventListener(
                            "click",
                            this.unmount
                        ),
    ...
    return (
        ...
        (X.getCharacters = () => (null == T && Q(), U(T))),
        (X.registerCharacter = (t, e) => {
            const i = U(e);
            let s = i.initialState.i;
            (s = Math.min(0.5, Math.max(0, s))),
                (i.initialState.i = s),
                (T[t] = i);
        }),
        X
